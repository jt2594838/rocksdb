...
namespace ROCKSDB_NAMESPACE {
    ...
    void RocksService::Start() {
        ...
        std::shared_ptr<apache::thrift::concurrency::ThreadManager> internal_thread_manager(
                apache::thrift::concurrency::ThreadManager::newSimpleThreadManager(
                        CORE_NUM, 100));
        std::shared_ptr<apache::thrift::concurrency::ThreadManager> external_thread_manager(
                apache::thrift::concurrency::ThreadManager::newSimpleThreadManager(
                        CORE_NUM, 100));
