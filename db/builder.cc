...
Status BuildTable(
  ...
  if (iter->Valid() || !range_del_agg->IsEmpty()) {
    ...
    c_iter.SeekToFirst();
    ROCKS_LOG_INFO(ioptions.info_log, "[JOB %d] start to build table", job_id);
    ...
    ROCKS_LOG_INFO(ioptions.info_log, "[JOB %d] new table is build", job_id);
    ...
    ROCKS_LOG_INFO(ioptions.info_log, "[JOB %d] new table is checked", job_id);
  }
